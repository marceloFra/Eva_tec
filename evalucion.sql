...
(
  id_Depa int  primary key not null,
  departamento varchar(50) not null
)

---------DEPARTAMENTOS-------------
insert into Departamentos (id_Depa, departamento) Values
(1, 'AMAZONAS'),
(2, 'ANCASH'),
(3, 'APURIMAC'),
(4, 'AREQUIPA'),
...
(
  ...
  id_Depa int  foreign key (id_Depa) references Departamentos not null,
)

insert into Provincia (id_Provincia, provincia,id_Depa ) Values
(1, 'CHACHAPOYAS ', 1),
(2, 'BAGUA', 1),
(3, 'BONGARA', 1),
(4, 'CONDORCANQUI', 1),
...
(
  ...
  id_Provincia int  foreign key (id_Provincia) references Provincia not null,
)
...
create procedure sp_List_Deparatamento
as
SELECT   [id_Depa]
      ,[departamento]
  FROM [softmania].[dbo].[Departamentos]

 
create procedure sp_List_Provincia
@id_Depa int
as
SELECT [id_Provincia]
      ,[provincia]
      ,[id_Depa]
  FROM [softmania].[dbo].[Provincia]  where id_Depa = @id_Depa
   
 

create procedure sp_List_Distrito
@id_Provincia int 
as 
SELECT [id_Distrito]
      ,[distrito]
      ,[id_Provincia]
  FROM [softmania].[dbo].[Distrito] where id_Provincia = @id_Provincia
...
(
  id_Documento int identity(100,1) primary key,
  tipo_Documento varchar(50) not null
)

insert into Documento VALUES( 'DNI')
insert into Documento VALUES( 'Pasaporte')

create proc sp_listDocu
as
...
(
 ...
 id_Documento int  foreign key (id_Documento) references Documento not null,
 nro_documento char(12) not null,
 usu  varchar(50) not null,
 contrasena varchar(50) not null,
 id_Depa int  foreign key (id_Depa) references Departamentos not null,
 id_Provincia int  foreign key (id_Provincia) references Provincia not null, 
 id_Distrito int  foreign key (id_Distrito) references Distrito not null, 
)

drop proc sp_updateUsuario
 ...
 @id_Distrito int
 as
 insert into  Usuario values(@nombre,@apellido_Paterno,@apellido_Materno, @id_Documento, @nro_documento, @usu, @contrasena, @id_Depa, @id_Provincia, @id_Distrito);
...
go 
 ...
 @id_Distrito int
 as
 update   Usuario set nombre = @nombre,apellido_Paterno = @apellido_Paterno,apellido_Materno = @apellido_Materno, 
 id_Documento = @id_Documento, nro_documento = @nro_documento, usu  = @usu ,contrasena = @contrasena, 
 id_Depa = @id_Depa, id_Provincia = @id_Provincia,id_Distrito = @id_Distrito where  id_Usuario = @id_Usuario;
 ...
 as
 select * from Usuario 
 where usu  = @usu and contrasena = @contrasena
